				...
				<div className='headerfont' style={{padding:10}}>
					<div style={{display:'flex',flexDirection:'row'}}>
						...
						<div style={{paddingTop:'50px'}} className='navigation'>
							<List link>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:undefined})}} style={{height:'28px',paddingBottom:'3px',borderBottom:(this.state.currentPage === undefined ? '2px black solid' : '')}} to={{pathname: '/'}}>
										About
									</Link>
								</List.Item>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:'projects'})}} style={{height:'28px',paddingBottom:'3px',borderBottom:(this.state.currentPage === 'projects' ? '2px black solid' : '')}} to={{pathname: '/projects'}}>
										Projects
									</Link>
								</List.Item>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:'contact'})}} style={{height:'28px',paddingBottom:'3px',borderBottom:(this.state.currentPage === 'contact' ? '2px black solid' : '')}} to={{pathname: '/contact'}}>
										Contact
									</Link>
								</List.Item>
							</List>
				...
				<Grid style={{padding:20}} columns={2} divided>
					...
					<Grid.Column className='headerfont' style={{paddingLeft:'10px'}} width={6}>
						...
						<div className='navigation'>
							<List link>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:undefined})}} style={{height:'28px',paddingBottom:'1px',borderBottom:(this.state.currentPage === undefined ? '2px black solid' : '')}} to={{pathname: '/'}}>
										About
									</Link>
								</List.Item>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:'projects'})}} style={{height:'28px',paddingBottom:'1px',borderBottom:(this.state.currentPage === 'projects' ? '2px black solid' : '')}} to={{pathname: '/projects'}}>
										Projects
									</Link>
								</List.Item>
								<List.Item>
									<Link onClick={()=>{this.setState({currentPage:'contact'})}} style={{height:'28px',paddingBottom:'1px',borderBottom:(this.state.currentPage === 'contact' ? '2px black solid' : '')}} to={{pathname: '/contact'}}>
										Contact
									</Link>
								</List.Item>
							</List>
